...
1. 🆓️Unboxing Armsom Forge 1 Industrial Grade SBC Powered By RK3506J Triple- Core Cortex-A7 Processor [**[Watch]**](https://youtube.com/shorts/hVaOORNnbXU)

$\color{Green}\Huge{\textbf{Getting Started Guide}}$

1. ⏳️Getting Started with ArmSom Forge1 | Flashing Buildroot OS to NAND Storage | USB Debugging | **[Watch]**
2. ⏳️Getting Started with ArmSom Forge1 | Flashing Buildroot OS to SD Card | USB Debugging | **[Watch]**
